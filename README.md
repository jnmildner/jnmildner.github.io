# PBHM Workshop links and resources
...
## Coding resources for beginners in Python:

- [Getting started with colab](https://colab.research.google.com/#scrollTo=GJBs_flRovLc)
- [Python cheat sheets](https://ehmatthes.github.io/pcc_3e/cheat_sheets/). *Useful if you have already completed an intro course on Python or if you know another programming language (such as R) and just need syntax reminders.*
...
- [MTEB Leaderboard](https://huggingface.co/spaces/mteb/leaderboard). *Comparison of hundreds of text and image embedding models on a variety of benchmarks. You can filter by lots of useful parameters, such as language, task type, model size, open-source, etc to find the current top embedding models.*
